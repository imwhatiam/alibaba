...
from seahub.constants import (
    ...
    REPO_STATUS_NORMAL, REPO_STATUS_READ_ONLY, PERMISSION_READ_WRITE_NO_SYNC
)
...
def parse_repo_perm(perm):
    ...
    RP.can_download = True if perm in [
        PERMISSION_READ, PERMISSION_READ_WRITE, PERMISSION_ADMIN, PERMISSION_READ_WRITE_NO_SYNC] else False
    RP.can_upload = True if perm in [
        PERMISSION_READ_WRITE, PERMISSION_ADMIN, PERMISSION_READ_WRITE_NO_SYNC] else False
    RP.can_edit_on_web = True if perm in [
        PERMISSION_READ_WRITE, PERMISSION_ADMIN, PERMISSION_PREVIEW_EDIT, PERMISSION_READ_WRITE_NO_SYNC
    ] else False
    RP.can_copy = True if perm in [
        PERMISSION_READ, PERMISSION_READ_WRITE, PERMISSION_ADMIN, PERMISSION_READ_WRITE_NO_SYNC,
    ] else False
    RP.can_preview = True if perm in [
        PERMISSION_READ, PERMISSION_READ_WRITE, PERMISSION_ADMIN,
        PERMISSION_PREVIEW, PERMISSION_PREVIEW_EDIT, PERMISSION_READ_WRITE_NO_SYNC
    ] else False
