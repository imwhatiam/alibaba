...
class AlibabaProfile(models.Model):
    ...
    personal_photo_url = models.CharField(max_length=1024, blank=True, null=True)
    ...
    work_no = models.CharField(max_length=191)
    post_name = models.CharField(max_length=191)
    post_name_en = models.CharField(max_length=191)
    dept_name = models.TextField()
    dept_name_en = models.TextField()
    work_status = models.CharField(max_length=4)
    gmt_leave = models.DateTimeField(blank=True, null=True)
    gmt_entry = models.DateTimeField()
    emp_name_en = models.CharField(max_length=64, blank=True, null=True)
