...
import DesktopSyncingClients from './pages/desktop-syncing-clients/desktop-syncing-clients';
...
const DesktopSyncingClientsWrapper = MainContentWrapper(DesktopSyncingClients);
        ...
        <div id="main">
          ...
          <MainPanel>
            <Router className="reach-router">
              ...
              <DesktopSyncingClientsWrapper path={siteRoot + 'desktop-syncing-clients'} onShowSidePanel={this.onShowSidePanel} onSearchedClick={this.onSearchedClick} />
